...
const CACHE_NAME = "homegym-shell-v2.5.6";
    ...
    caches.keys()
      .then(keys => Promise.all(
        keys.filter(key => key !== CACHE_NAME && (
          key.startsWith("homegym-shell") ||
          key.startsWith("plateplan") ||
          key.startsWith("home-gym") ||
          key.includes("home-gym")
